...
<!-- ===== BANNER ===== -->
<section class="ca-banner" style="background-image:url('assets/images/amenities/Accommodation/triple-share-room/facilities-banner.jpg')">
  <div class="ca-banner-overlay">
    <div class="ca-breadcrumb">
      <a href="index.php">Home</a>»  Amenities»  Accommodation  » <strong>Triple Share Room</strong>
    </div>
  </div>
</section>
...
<section class="amenities-section">
  <div class="amenities-grid">
    ...
    <div class="amenity-item" data-gallery="1">
      <img src="assets/images/amenities/Accommodation/triple-share-room/tripleshareroom.jpg">
    ...
    <div class="amenity-item" data-gallery="2">
      <img src="assets/images/amenities/Accommodation/triple-share-room/tripleshareroom2.jpg">
      <div class="amenity-overlay">
        <h3>Room</h3>
        <button class="btn-look">Take a look</button>
      </div>
...
<script>
const images = [
  'assets/images/amenities/Accommodation/triple-share-room/tripleshareroom.jpg',
  'assets/images/amenities/Accommodation/triple-share-room/tripleshareroom2.jpg'
];
