...
<!-- ===== BANNER ===== -->
<section class="ca-banner" style="background-image:url('assets/images/amenities/Accommodation/deluxe-ac-room/facilities-banner.jpg')">
  <div class="ca-banner-overlay">
    <div class="ca-breadcrumb">
      <a href="index.php">Home</a>»  Amenities»  Accommodation  » <strong>Deluxe Room</strong>
    </div>
  </div>
</section>
...
<section class="amenities-section">
  <div class="amenities-grid">
    ...
    <div class="amenity-item" data-gallery="1">
      <img src="assets/images/amenities/Accommodation/deluxe-ac-room/deluxeacroom1.jpg">
...
<script>
const images = [
  'assets/images/amenities/Accommodation/premium-room/deluxeacroom1.jpg'
];
