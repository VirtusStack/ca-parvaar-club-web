...
<!-- ===== BANNER ===== -->
<section class="ca-banner" style="background-image:url('assets/images/amenities/steamsauna/detoxify-banner.jpg')">
  <div class="ca-banner-overlay">
    <div class="ca-breadcrumb">
      <a href="index.php">Home</a> »  Amenities »  <strong>Steam, Sauna & Jacuzzi</strong>
    </div>
  </div>
</section>
...
<section class="amenities-section">
  <div class="amenities-grid">
    ...
    <div class="amenity-item" data-gallery="1">
      <img src="assets/images/amenities/steamsauna/steam.jpg">
    ...
    <div class="amenity-item" data-gallery="2">
      <img src="assets/images/amenities/steamsauna/sauna.jpg">
      <div class="amenity-overlay">
        <h3>Sauna</h3>
        <button class="btn-look">Take a look</button>
      </div>
    ...
    <div class="amenity-item" data-gallery="3">
      <img src="assets/images/amenities/steamsauna/jacuzzi.jpg">
      <div class="amenity-overlay">
        <h3>Jacuzzi</h3>
        <button class="btn-look">Take a look</button>
      </div>
...
<script>
const images = [
    'assets/images/amenities/steamsauna/steam.jpg',
  'assets/images/amenities/steamsauna/sauna.jpg',
  'assets/images/amenities/steamsauna/jacuzzi.jpg'
];
