...
<section class="ca-banner" style="background-image:url('assets/images/amenities/steamsauna/detoxify-banner.jpg')">
  <div class="ca-banner-overlay">
    <div class="ca-breadcrumb">
      <a href="index.php">Home</a> »  Amenities »  <strong>Detoxify</strong>
    </div>
  </div>
</section>
...
<section class="amenities-section">
  <div class="amenities-grid">
    ...
    <div class="amenity-item" data-gallery="1">
      <img src="assets/images/amenities/steamsauna/yoga.jpg">
    ...
    <div class="amenity-item" data-gallery="2">
      <img src="assets/images/amenities/steamsauna/muse.jpg">
      <div class="amenity-overlay">
        <h3>Muse</h3>
        <button class="btn-look">Take a look</button>
      </div>
    ...
    <div class="amenity-item" data-gallery="3">
      <img src="assets/images/amenities/steamsauna/meditation.jpg">
      <div class="amenity-overlay">
        <h3>Meditation</h3>
        <button class="btn-look">Take a look</button>
      </div>
...
<script>
const images = [
    'assets/images/amenities/steamsauna/yoga.jpg',
  'assets/images/amenities/steamsauna/muse.jpg',
  'assets/images/amenities/steamsauna/meditation.jpg'
];
