...
<!-- ===== BANNER ===== -->
<section class="ca-banner" style="background-image:url('assets/images/amenities/indoor/indoor-banner.jpg')">
...
<section class="amenities-section">
  <div class="amenities-grid">
    ...
    <div class="amenity-item" data-gallery="1">
      <img src="assets/images/amenities/indoor/billiards.jpg">
    ...
    <div class="amenity-item" data-gallery="2">
      <img src="assets/images/amenities/indoor/table-tennis.jpg">
      <div class="amenity-overlay">
        <h3>Table Tennis</h3>
        <button class="btn-look">Take a look</button>
      </div>
    ...
    <div class="amenity-item" data-gallery="3">
      <img src="assets/images/amenities/indoor/carrom.jpg">
      <div class="amenity-overlay">
        <h3>Carrom</h3>
        <button class="btn-look">Take a look</button>
      </div>
    ...
    <div class="amenity-item" data-gallery="4">
      <img src="assets/images/amenities/indoor/chess.jpg">
      <div class="amenity-overlay">
        <h3>Chess</h3>
        <button class="btn-look">Take a look</button>
      </div>
    ...
    <div class="amenity-item" data-gallery="5">
      <img src="assets/images/amenities/indoor/dart.jpg">
      <div class="amenity-overlay">
        <h3>Dart</h3>
        <button class="btn-look">Take a look</button>
      </div>
    ...
    <div class="amenity-item" data-gallery="6">
      <img src="assets/images/amenities/indoor/library.jpg">
      <div class="amenity-overlay">
        <h3>library</h3>
        <button class="btn-look">Take a look</button>
      </div>
    ...
    <div class="amenity-item" data-gallery="7">
      <img src="assets/images/amenities/indoor/wi-fi-campus.jpg">
      <div class="amenity-overlay">
        <h3>Wifi </h3>
        <button class="btn-look">Take a look</button>
      </div>
    ...
    <div class="amenity-item" data-gallery="8">
      <img src="assets/images/amenities/indoor/general-stores.jpg">
      <div class="amenity-overlay">
        <h3>General Store</h3>
        <button class="btn-look">Take a look</button>
      </div>
