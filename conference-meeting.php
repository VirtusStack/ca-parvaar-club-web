...
<section class="ca-banner" style="background-image:url('assets/images/club/conference-banner.jpg')">
  <div class="ca-banner-overlay">
    <div class="ca-breadcrumb">
      <a href="index.php">Home</a> »  Club  »  <strong>Conference & Meetings</strong>
    </div>
  </div>
</section>
...
<section class="ca-conference-wrapper">
  <div class="ca-conference-container">
    ...
    <div class="ca-conference-right">
      ...
      <p>
        The CA PARIWAR CLUB has multiple venues to cater to the needs of the
        corporate world. These exclusive venues are a blend of exquisite
        interiors, latest technologies, gourmet catering and convenient
        location.
      </p>
